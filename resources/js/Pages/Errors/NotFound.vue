    ...
    <section class="">
        <div class="mx-auto max-w-7xl  sm:px-6 lg:px-8">
            <div class="w-full flex-col justify-start items-center lg:gap-16 gap-10 inline-flex lg:pt-[180px] pt-12 lg:pb-28 pb-12">
                <div class="border border-orange-600 h-[550px] rounded-lg w-full">
                    <div class="p-8 flex justify-between items-center border-b border-orange-600">
                        <div class="block">
                            <svg width="204" height="18" viewBox="0 0 204 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="8.78677" cy="8.78677" r="8.78677" transform="matrix(1 0 0 -1 0 17.6912)" fill="#ea580c" />
                                <circle cx="8.78677" cy="8.78677" r="8.78677" transform="matrix(1 0 0 -1 28.1177 17.6912)" fill="#ea580c" />
                                <circle cx="8.78677" cy="8.78677" r="8.78677" transform="matrix(1 0 0 -1 56.2353 17.6912)" fill="#ea580c" />
                                <path d="M91.3824 8.9044C91.3824 13.7572 95.3164 17.6912 100.169 17.6912H195.066C199.919 17.6912 203.853 13.7572 203.853 8.9044C203.853 4.0516 199.919 0.117632 195.066 0.117632H100.169C95.3163 0.117632 91.3824 4.0516 91.3824 8.9044Z" fill="#ea580c" />
                            </svg>
                        </div>
                        <div class="block">
                    ...
                    >
                        ...
                        <div class="block text-center mt-5">
                            <h5
                                class="md:text-xl text-lg leading-8  font-medium mb-1.5"
                            >
